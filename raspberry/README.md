...
> **Versión en Ladder (LD):** la misma ley de control expresada como diagrama de escalera
> (IEC 61131-3 / LD) está en [`ladder/`](ladder/) — es la versión desplegada para la demo y
> la evidencia de que el control vive en OpenPLC en el lenguaje gráfico del curso. El `.st` de
> esta carpeta queda como referencia equivalente (además calcula la palabra `Estado`).
